...
final GlobalKey<TravelStyleViewState> travelStyleViewKey = GlobalKey<TravelStyleViewState>();
...
Widget build(BuildContext context) {
      ...
      child: ClipRect(
        child: Stack(
          children: [
            ...
            RelaxView(key:relaxViewKey, animationController: _animationController, signUpData: signUpData),
            CareView(key:careViewKey, animationController:_animationController, signUpData: signUpData,),
            TravelStyleView(key: travelStyleViewKey, animationController: _animationController,),
  ...
  if (_animationController.value >= 0 && _animationController.value <= 0.2) {
    ...
    if (relaxState != null) {
      ...
      debugPrint("🟢 이메일: ${signUpData.email}, 비번: ${signUpData.password}, 닉네임: ${signUpData.nickname}");
    }
    ...
    if (careState != null && careState.gender != null && careState.age != null) {
...
State? _getStateOf<T extends StatefulWidget>() {
  ...
  if (element != null && element.widget.runtimeType.toString() == widgetType) {
    return element;
  }
  return null;
}
